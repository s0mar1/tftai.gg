...
type TraitVariant = 'none' | 'bronze' | 'silver' | 'gold' | 'chromatic' | 'prismatic';

interface TraitHexIconProps {
 ...
 */
export default function TraitHexIcon({ variant = "none", size = 32, className = "", uniqueId }: TraitHexIconProps): JSX.Element {
  /* ───────────────────────────────────────── viewBox 상수 ────────────────── */
  ...
  /* ────────────────────────────────────── 색상 preset 정의 ───────────────── */
  const colorConfigs: Record<TraitVariant, ColorConfig> = {
